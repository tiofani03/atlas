      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl w-full max-w-md p-6 space-y-4 shadow-2xl">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-zinc-100">Configure Confluence Connector</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <div>
            <label className="block text-zinc-400 font-medium mb-1">Spaces (comma-separated)</label>
            <input
              type="text"
              value={spaces}
